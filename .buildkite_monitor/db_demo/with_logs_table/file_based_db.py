...
from db_functions import fetch_data, types_fix, bronze_builds, bronze_jobs_logs, bronze_agents, calculate_wait_time, bronze_jobs_ids_for_logs
...
bronze_jobs = bronze_jobs_ids_for_logs(jobs, jobs_bronze_path, job_logs_bronze_path, BUILDKITE_API_TOKEN, ORGANIZATION_SLUG, PIPELINE_SLUG, False)
...
bronze_agents = bronze_agents(agents, agents_bronze_path, False)    
