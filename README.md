...
For benchmarking, pin exact package versions so runs stay reproducible; you can get these versions by running `uv pip list` on a working install. The example below pins the versions that were current at the time this was written:
