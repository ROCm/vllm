...
@pytest.mark.parametrize(
    ...
    [
        ...
        # in chunks. Each batch gets a different per-row window, hence a
        # different number of reloads: one at batch 2 and 3, two at 4, three at
        # 5 with a short final chunk. 20992 is not a multiple of the K step
        # either, so it crosses a chunk boundary *and* has a ragged K tail.
        (2, 20480, 512, 64),
        (3, 16384, 512, 32),
        (4, 16384, 512, 128),
        (5, 21504, 512, 32),
