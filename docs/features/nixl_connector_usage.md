...
For ROCm platform, the [instructions](../getting_started/installation/gpu.rocm.inc.md) includes how to enable rixl with ucx using [the docker file](../../docker/Dockerfile.rocm_deepep).
