...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_WIDE_DECODE_ATTN: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # forces the Triton path. Read via rocm_wide_decode_attn.is_enabled().
    "VLLM_ROCM_WIDE_DECODE_ATTN": lambda: os.environ.get(
        "VLLM_ROCM_WIDE_DECODE_ATTN", None
    ),
