...
class Indexer(nn.Module):
    ...
    def forward(
        ...
        # In-place RoPE: the CUDA/HIP kernel modifies the slice views directly,
        # avoiding split + concat overhead. Only the first rope_dim dimensions
        # are rotated; the remaining dimensions are untouched.
        rotary_emb(
            positions,
            q[..., : self.rope_dim],
