...
class PassConfig:
    ...
    aiter_fuse_allreduce_rms: bool = False
    """Enable aiter's allreduce RMSNorm fusion."""
    ...
    def __post_init__(self) -> None:
        ...
        if self.aiter_fuse_allreduce_rms and not current_platform.is_rcom():
            ...
            self.aiter_fuse_allreduce_rms = False
            # if self.enable_fusion:
            #     logger.warning_once(
            #         "AITER all-reduce + RMSNorm fusion "
            #         "enabled which contains the RMSNorm + "
            #         "quant (fp8) fusion. "
