...
class DeepseekV4Attention(nn.Module, AttentionLayerBase, ABC):
    ...
    def __init__(
        ...
        # Precomputed BF16 wo_a for the ROCm inv-rope einsum, set at load by
        # prepare_wo_a_dequant() to skip the per-step e8m0 dequant (an opt the
        # upstream _o_proj path does not have). None until prepared / on non-ROCm.
