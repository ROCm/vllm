...
class ROCMAiterMLASparseMetadataBuilder(
    ...
    def build(
        ...
        num_batches = common_attn_metadata.num_reqs
...
class ROCMAiterMLASparseImpl(MLACommonBaseImpl[ROCMAiterMLASparseMetadata]):
    ...
    def _forward_bf16_kv(
        ...
        # attn_metadata.buffer_for_paged_kv_indices.copy_(attn_metadata.paged_kv_indices)
        # attn_metadata.buffer_for_paged_kv_indptr.copy_(attn_metadata.paged_kv_indptr)
        # if attn_metadata.max_query_len == 1:
        #     torch.cuda.synchronize()
        #     print("in decode end of fetch_id_to_ragged_triton ", flush=True)
        ...
        # if attn_metadata.max_query_len == 1:
        #     torch.cuda.synchronize()
        #     print("in decode end of mla decode ", flush=True)
