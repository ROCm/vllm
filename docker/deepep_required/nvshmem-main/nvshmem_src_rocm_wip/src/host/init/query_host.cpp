...
NVSHMEMI_HOSTDEVICE_PREFIX int nvshmem_my_pe(void) { return nvshmemi_boot_handle.pg_rank; }

NVSHMEMI_HOSTDEVICE_PREFIX int nvshmem_n_pes(void) { return nvshmemi_boot_handle.pg_size; }
...
NVSHMEMI_HOSTDEVICE_PREFIX void nvshmemx_vendor_get_version_info(int *major, int *minor, int *patch) {
