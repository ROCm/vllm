...
//#include <hip/driver_types.h>                  // for ihipStream_t, hipStream_t
#include <limits.h>                        // for CHAR_MIN
#include <stdio.h>                         // for size_t, stderr, fflush
#include "cpu_coll.h"                      // lines 13-13
#include "device_host/nvshmem_common.hip.h"  // for RDXN_OPS_AND, RDXN_OPS_MAX
...
template <>
inline ncclDataType_t nvshmemi_get_nccl_dt<hip_bfloat16>() {
    return ncclBfloat16;
}
template <>
