...
#define NVSHMEM_TYPE_INC_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX void nvshmem_##Name##_atomic_inc(TYPE *target, int pe) {                        \
...
#define NVSHMEM_TYPE_ADD_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX void nvshmem_##Name##_atomic_add(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_SET_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX void nvshmem_##Name##_atomic_set(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_AND_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX void nvshmem_##Name##_atomic_and(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_OR_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX void nvshmem_##Name##_atomic_or(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_XOR_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX void nvshmem_##Name##_atomic_xor(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_FETCH_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_fetch(const TYPE *target, int pe) {                  \
...
#define NVSHMEM_TYPE_FETCH_INC_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_fetch_inc(TYPE *target, int pe) {                        \
...
#define NVSHMEM_TYPE_FETCH_ADD_NOT_IMPLEMENTED(Name, TYPE)                           \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_fetch_add(TYPE *target, TYPE value, int pe) {       \
...
#define NVSHMEM_TYPE_SWAP_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_swap(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_COMPARE_SWAP_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_compare_swap(TYPE *target, TYPE cond, TYPE value, int pe) { \
...
#define NVSHMEM_TYPE_FETCH_AND_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_fetch_and(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_FETCH_OR_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_fetch_or(TYPE *target, TYPE value, int pe) {            \
...
#define NVSHMEM_TYPE_FETCH_XOR_NOT_IMPLEMENTED(Name, TYPE)                                \
    NVSHMEMI_HOSTDEVICE_PREFIX TYPE nvshmem_##Name##_atomic_fetch_xor(TYPE *target, TYPE value, int pe) {            \
