...
class nvshmemi_mem_p2p_transport final {
...
#endif
    hipMemAllocationHandleType get_mem_handle_type(void) const { return nvshmemi_mem_handle_type_; }
   ...
   private:
    ...
    hipMemAllocationHandleType nvshmemi_mem_handle_type_ = hipMemHandleTypePosixFileDescriptor;
};
