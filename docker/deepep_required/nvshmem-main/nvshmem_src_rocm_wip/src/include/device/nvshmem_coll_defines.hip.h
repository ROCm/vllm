...
#include "non_abi/device/coll/defines.hip.h"
...
NVSHMEMI_STATIC NVSHMEMI_HOSTDEVICE_PREFIX NVSHMEMI_DEVICE_INLINE int nvshmem_alltoallmem(
...
#define DEFN_NVSHMEM_TYPENAME_ALLTOALL(TYPENAME, TYPE)                                       \
    NVSHMEMI_STATIC NVSHMEMI_HOSTDEVICE_PREFIX                                                   \
...
NVSHMEMI_STATIC NVSHMEMI_HOSTDEVICE_PREFIX NVSHMEMI_DEVICE_INLINE int nvshmem_barrier(
    nvshmem_team_t team) {
    nvshmemi_barrier_threadgroup<nvshmemi_threadgroup_thread>(team);
    return 0;
}

NVSHMEMI_STATIC NVSHMEMI_HOSTDEVICE_PREFIX NVSHMEMI_DEVICE_INLINE void nvshmem_barrier_all() {
    nvshmemi_barrier_threadgroup<nvshmemi_threadgroup_thread>(NVSHMEM_TEAM_WORLD);
}

NVSHMEMI_STATIC NVSHMEMI_HOSTDEVICE_PREFIX NVSHMEMI_DEVICE_INLINE int nvshmem_team_sync(
    nvshmem_team_t team) {
    nvshmemi_sync_threadgroup<nvshmemi_threadgroup_thread>(team);
    return 0;
}

NVSHMEMI_STATIC NVSHMEMI_HOSTDEVICE_PREFIX NVSHMEMI_DEVICE_INLINE void nvshmem_sync_all() {
