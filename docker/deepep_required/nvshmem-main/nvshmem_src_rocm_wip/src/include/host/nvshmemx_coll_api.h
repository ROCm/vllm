...
#define DECL_NVSHMEMX_TYPENAME_ALLTOALL_ON_STREAM(TYPENAME, TYPE)                                  \
    int nvshmemx_##TYPENAME##_alltoall_on_stream(nvshmem_team_t team, TYPE *dest, const TYPE *src, \
                                                 size_t nelem, hipStream_t stream);
...
void nvshmemx_barrier_all_on_stream(hipStream_t);

// sync collectives
int nvshmemx_team_sync_on_stream(nvshmem_team_t team, hipStream_t stream);
void nvshmemx_sync_all_on_stream(hipStream_t);
...
#define NVSHMEMI_DECL_REDUCE_ONSTREAM(NAME, TYPE, OP)                         \
    NVSHMEMI_HOSTDEVICE_PREFIX int nvshmemx_##NAME##_##OP##_reduce_on_stream( \
        nvshmem_team_t team, TYPE *dest, const TYPE *src, size_t nreduce, hipStream_t stream);
